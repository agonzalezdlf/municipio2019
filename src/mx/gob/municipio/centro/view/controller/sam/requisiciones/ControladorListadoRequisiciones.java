...
public class ControladorListadoRequisiciones extends ControladorBase {
	...
	public String  requestGetControlador( Map modelo, HttpServletRequest request ) {
		...
		List <Map<String, Object>> lista = this.getRequisicionesUnidadPorEjemplo(unidad, estatus,fechaIni,fechaFin, this.getSesion().getEjercicio(), tipo, verUnidad, numreq, proyecto, partida, tipogto,beneficiario, privilegio, cboconOP, listadoReq);
    ...
    public List<Map<String, Object>> getRequisicionesUnidadPorEjemplo(String unidad , String  estatus,String fechaInicial,String fechaFinal,Integer ejercicio, Integer tipo, String  verUnidad, String numreq, String proyecto, String clv_partid, String tipogto,  String beneficiario, boolean privilegio, String cboconOP, String listadoReq){
	...
	public List<Map<String, Object>> getTipoRequisicion(){
	...
	public Map<String, Object> getFechaIngreso(Long cve_req){
