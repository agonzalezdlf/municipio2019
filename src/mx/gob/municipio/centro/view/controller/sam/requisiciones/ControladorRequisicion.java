...
*/
	...
	public List<Map<String, Object>>getBeneficiarios(){
		return (java.util.List<Map<String, Object>>) gatewayBeneficiario.getListaBeneficiarios();
	}
	...
	public List<Map<String, Object>> getMes(){
	...
	public List <Map<String, Object>>getConceptosRequisicion(Long cve_req){
		return this.gatewayMovimientosRequisicion.getConceptos4(cve_req);
	}
	
	public Map<String, Object> getConceptoRequisicion(Long id_req_movto){
		return this.gatewayMovimientosRequisicion.getConcepto(id_req_movto);
	}
	
	public Map<String, Object> getRequisicion(Long cve_req){
	...
	public List <Map<String, Object>> getListaValesPresupuesto(Long cve_vale, String clv_benefi, int idRecurso, int tipo_doc, int idDependencia){
