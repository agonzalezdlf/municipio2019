...
public class ControladorProyectoPartida extends ControladorBase {	
	...
	public List<Map<String, Object>> getPresupuestoContrato(Long idproyecto, String proyecto, String partida, Integer mes, int idTipoGasto, int idUnidad, Long cve_contrato){
	...
	public List<Map<String, Object>> getPresupuestoVale(Long idproyecto, String proyecto, String partida, Integer mes, int idTipoGasto, int idUnidad, Long idVale){
	...
	public List<Map<String, Object>> getPresupuesto(Long idproyecto, String proyecto, String partida, Integer mes, int idTipoGasto, int idUnidad ){
	...
	public List<Map<String, Object>> getProgramas(int idDependencia, int tipoGasto){
    ...
    public List<Map<String, Object>> getPartidas(Long idproyecto){
    	if(idproyecto!=0){
    ...
    public List<Map<String, Object>> getListaValesPresupuesto(Long cve_vale, int idproyecto, String clv_partid, int idRecurso, int mes){
    	String clausula = ""; 
    ...
    public void eliminarArchivoFisico(int cve_pers, Long idArchivo, HttpServletRequest request){
		...
		Map<String, Object> archivo = this.getJdbcTemplate().queryForMap("SELECT *FROM SAM_PROYECTOS_ARCHIVOS WHERE ID_ARCHIVO =?", new Object[]{idArchivo});
		/*eliminado fisico*/
