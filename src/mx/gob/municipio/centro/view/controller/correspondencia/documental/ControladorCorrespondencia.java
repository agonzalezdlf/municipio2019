...
public class ControladorCorrespondencia extends ControladorBaseCorrespondencia {
    ...
    public List<Map<String, Object>> getTipoCorrespondencia(){
	...
	public List<Map<String, Object>> getPersonasSubdireccion(){
		return gatewayMinutarios.getPersonasCorrespondencia();
	}
	
	public List<Map<String, Object>> getListaPersonas(String[] cve_pers){
