...
public class ControladorEntradasDocumentos extends ControladorBaseAlmacen  {
	...
	public String  requestGetControlador( Map modelo, HttpServletRequest request ) {
		...
		Map<String, Object> m = this.getEntradaDocumento(Long.parseLong(modelo.get("id_entrada").toString()));
    ...
    public List<Map<String, Object>> getListaTiposDocumentos(){
	...
	@ModelAttribute("familiasArticulos")
	 public List<Map<String, Object>> getListaFamiliasArticulos(){
	...
	public List <Map<String, Object>>getAlmacenes(Long idDependencia){
		return gatewayAlmacen.getAlmacenesUnidad(idDependencia);
	}
	
	 public List<Map<String, Object>> getTiposEntradas(){
	...
	public Map<String, Object> getEntradaDocumento(Long id_entrada){
	...
	public Map<String, Object> getConcepto(Long id_detalle_entrada){
