...
public class GatewayMeses extends BaseGateway {
	...
	public List<Map<String, Object>> getTodosMesesEjercicioActivos(Integer ejercicio){		
		  return this.getJdbcTemplate().queryForList("select * from MESES where  ESTATUS ='ACTIVO' and ejercicio=?",new Object []{ejercicio});		
		}
	
	public List<Map<String, Object>> getTodosMesesEjercicioEvaluacion(Integer ejercicio, boolean privilegio){	
		if(privilegio)
			return this.getJdbcTemplate().queryForList("select * from MESES where ejercicio=?",new Object []{ejercicio});
		else
	...
	public List<Map<String, Object>> getMesesRequisicion(Integer ejercicio){		
		  return this.getJdbcTemplate().queryForList("select * from MESES where ejercicio=?",new Object []{ejercicio});		
		}
