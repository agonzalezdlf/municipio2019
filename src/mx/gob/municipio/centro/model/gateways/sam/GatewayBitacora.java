...
public class GatewayBitacora extends BaseGateway {
	...
	public static int OP_RECEP_EN_PROGRAMACION	= 58;
	public static int OP_RECEP_EN_FINANZAS	= 60;
	...
	/*USUARIOS*/
	public static int USER_ALTA	= 63;
	public static int USER_ACTUALIZACION  = 64;
	public static int USER_BAJA	= 65;
