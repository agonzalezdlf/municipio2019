...
public class GatewayProyectoPartidas extends BaseGateway {
	...
	public List<Map<String, Object>> getPartidasPorProyectos(String proyecto){
	...
	public List<Map<String, Object>> getPartidas(){
		return this.getJdbcTemplate().queryForList("select CLV_PARTID,PARTIDA  from  CAT_PARTID  order by CLV_PARTID ");
	}
	
	public List<Map<String, Object>> getPresupuestoValeDetalle(Long idproyecto, String clv_partid, int periodo, Long cve_doc){
	...
	public List<Map<String, Object>> getPresupuestoContrato(Long idproyecto, String proyecto, String partida, Integer mes, Integer idUsuario, int unidad, int tipoGasto, Long cve_contrato){		
		String SQL = "";
		...
		List<Map<String, Object>> resultado =  this.getNamedJdbcTemplate().queryForList(SQL,parametros);
		BigDecimal disponible = new BigDecimal("0.00");
		for (Map<String, Object> result :resultado ) {
	...
	public List<Map<String, Object>> getPresupuestoVale(Long idproyecto, String proyecto, String partida, Integer mes, Integer idUsuario, int unidad, int tipoGasto, Long idVale){		
		String SQL = "";
	...
	public List<Map<String, Object>> getPresupuesto(Long idproyecto, String proyecto, String partida, Integer mes, Integer idUsuario, int unidad, int tipoGasto){		
		String SQL = "";
		String sActual        = "";
		String sEjercido      = "";
	...
	public boolean verificarPresupuesto(Long idproyecto, String proyecto, String partida, int mes, Integer idUsuario, double importe ){
		boolean bol = false;
		List <Map<String, Object>> resultado = getPresupuesto(idproyecto, proyecto, partida, mes, idUsuario, 0,0);
		for (Map<String, Object> result :resultado ) {
	...
	//Demo para el pedido calendarizado
	public double getPreComprometidoMeses(Long proyecto, String partida, List calendario ,int mes) {
		try {
			Double comprometido=new Double(0);
			Map<String, Object> dt = this.getJdbcTemplate().queryForMap("SELECT ("+Meses[mes-1]+"PREREQ) AS DISP FROM PART_EXT2 WHERE  ID_PROYECTO=? and CLV_PARTID=? ",new Object[]{proyecto,partida});
	...
	public double getPreComprometidoMes(Long proyecto, String partida, int mes) {
		try{
			...
			Map<String, Object> dt = this.getJdbcTemplate().queryForMap("SELECT ("+Meses[mes-1]+"PREREQ) AS DISP FROM PART_EXT2 WHERE  ID_PROYECTO=? and CLV_PARTID=? ",new Object[]{proyecto,partida});
			     ...
			     comprometido = (dt.get("DISP")!=null)? Double.parseDouble(dt.get("DISP").toString()): 0.0D;
			     return comprometido.doubleValue();//Precompromiso del periodo
		}
		     catch ( DataAccessException e) {
					return 0.0D;
		}
	...
	public Map<String, Object> getPresupuestoProyectoPartida(String proyecto , String partida ) {		
		Map<String,Object> parametros = new HashMap<String,Object>();
		parametros.put("proyecto", proyecto);
		parametros.put("partida",partida);				
	...
	public Map<String, Object> getLightPartidaPresupuestal(String proyecto, String clv_partid){
		try  
		{
			String sql = "SELECT "+
							...
							"WHERE V.ID_PROYECTO = ?";
			Map<String, Object> resultado = this.getJdbcTemplate().queryForMap(sql, new Object []{clv_partid, proyecto});
			return resultado;
	...
	public List<Map<String, Object>> getProyectosAvances(int cve_pers){
	...
	/* 26 DE JULIO DE 2012*/
	public List<Map<String, Object>> getTodosProyectos(){
