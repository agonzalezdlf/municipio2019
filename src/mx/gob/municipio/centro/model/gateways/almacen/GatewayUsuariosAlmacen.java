...
public class GatewayUsuariosAlmacen extends BaseGatewayAlmacen {
	...
	public GatewayUsuariosAlmacen(){}
		...
		public List<Map<String, Object>> getUsuarioAlmacenes(String unidad, Integer idAlmacen){		
		...
		public List<Map<String, Object>> getAlmacenesUsuario(Integer idUsuario, String unidad ){		
