...
function getProyectosEval(edit,clave){
	autocompleteDiversosRemoto.getProyectosEval({
        ...
        errorHandler:function(errorString, exception) { 
			swal(exception.message+'<br><br>'+exception.javaClassName,'Error: autocompleteDiversosRemoto.getUnidad_Medidas');          				     	  
        }
    },async=false); 			 
}
...
/*Termina el autocomplet de unidades de medida...........*/
