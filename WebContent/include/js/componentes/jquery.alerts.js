...
(function($) {
	...
	$.alerts = {
		...
		_show2: function(title, msg, BotonOK, BotonCancel, NumBotones, callback) {
			...
			var pos = (navigator.appName == 'Microsoft Internet Explorer' && navigator.userAgent.match(/msie 6/i) ) ? 'absolute' : 'fixed';
			var botones = "";
			$("#popup_container").css({
				position: pos,
				zIndex: 99999,
		...
		_reposition: function() {
			...
			if( navigator.appName == 'Microsoft Internet Explorer' && navigator.userAgent.match(/msie 6/i) ) top = top + $(window).scrollTop();
