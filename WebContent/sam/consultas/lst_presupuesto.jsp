...
<table width="95%"  style="margin: 0 auto;"><tr><td><h1>Consultas - Presupuesto Calendarizado</h1></td></tr></table>
  <form name="forma" id="forma" method="post" action="lst_presupuesto.action">
  <table width="90%" border="0"  style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="listas">
    <tr  >
    ...
    <table width="90%" class="listas"  style="margin: 0 auto;" cellpadding="0" cellspacing="0">
    <tr>
