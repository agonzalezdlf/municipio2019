    ...
    <div class="panel with-nav-tabs panel-primary">
        <div class="panel-heading">
          <ul class="nav nav-tabs responsive" id="tabsOrdenesPane" name="tabsOrdenesPane">
                <li class="active"><a href="#tabsCabe" data-toggle="tab"><span>Información general</span></a></li>
                <li><a href="#tabsCon" data-toggle="tab">Conceptos</a></li>
                <li><a href="#tabsRet" data-toggle="tab"><span>Retenciones</span></a></li>
                <li><a href="#tabsDoc" data-toggle="tab">Anexos</a></li>
                <li><a href="#tabsVal" data-toggle="tab"><span>Vales</span></a></li>
            </ul>
        </div>
              ...
              <div class="tab-pane fade in active" id="tabsCabe">
 			  ...
 			  <div class="row">
                    <div class="form-group">
                        ...
                        <div class="form-group col-sm-3">
                            <input name="xConcurso"  type="text"  class="form-control" id="xConcurso" onBlur="upperCase(this)" value="0" maxlength="30" style="width:100%" />
                        </div>
              ...
              <div class="row">
               ...
               <div class="row">
                    <div class="form-group">
                        ...
                        <div class="form-group col-sm-3">
                            <textarea name="xNota"  type="textarea" wrap="virtual" cols="80" rows="4" class="form-control" id="xNota" value="0" maxlength="500" style="width:445px" onBlur="upperCase(this)"/></textarea>
                        </div>
