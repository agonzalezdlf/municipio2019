...
<c:forEach items="${vales}" var="item" varStatus="status"> 
 ...
 <c:if test="${fn:length(vales) > 0}">  
  <tr>
    <td colspan="8" align="left" height="30" style="background:#FFF"><c:if test="${fn:contains(status,'1')}" ><input type="button" value="Aplicar pago" id="cmdaplicar" name="cmdaplicar" class="botones"  style="width:150px"/> <input type="button" value="Rechazar" id="cmdrechazar" name="cmdrechazar" class="botones"   style="width:150px"/></c:if> 
