			                  ...
			                  <div class="row" id="fila_contrato">
			                    <div class="form-group">
			                        ...
			                        <div class="form-group col-sm-5">
				                        ...
				                        <input name="CCLV_PARTID" type="hidden"  id="CCLV_PARTID" size="8" maxlength="5" readonly value="" />
			                ...
			                <div id="div_os_vehiculo"><!--div_os_vehiculo-->  
			                  ...
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-2">
			                           	<input type="text" placeholder="Placas" id="txtplacas" maxlength="10" class="form-control sm" onBlur="upperCase(this)" style="width:150px;margin-bottom: 8px;" />
			                        </div>
										<!-- <label class="control-label col-sm-1" for="txtproyecto">Marca::</label> -->
										<div class="col-sm-1">
											<input type="text" placeholder="Color" id="txtcolor" maxlength="15" class="form-control sm" onBlur="upperCase(this)" style="width:100px" />
										</div>
			              ...
			              <!--Tipo de bien-->
			                  <div class="row">
			                    <div class="form-group">
			                        ...
			                        <div class="col-sm-2">
			                           	<input type="text" placeholder="Tipo de bien" id="txttipobien"  maxlength="15" onBlur="upperCase(this)" class="form-control sm" style="width:200px;margin-bottom: 8px;"/>
			                           </div>
										<!-- <label class="control-label col-sm-1" for="txtproyecto">Marca::</label> -->
										<div class="col-sm-2">
											<input type="text" placeholder="Marca" id="txtmarca" class="form-control sm" onBlur="upperCase(this)" maxlength="15" style="width:200px" />
										</div>
										<!-- <label class="control-label col-sm-1" for="cbomeses">Modelo:</label> -->
										<div class="col-sm-2">
											<input type="text" placeholder="Modelo" id="txtmodelo" maxlength="20" onBlur="upperCase(this)" class="form-control sm" style="width:130px" />
										</div>
			                     </div>
			                  </div> 
			                   <!--Usuario, Num. Invent-->
				                  <div class="row" style="border-bottom:15px !important;">
				                    <div class="form-group">
				                        <div class="control-label col-sm-3 ">Usuario:</div>
				                         	<div class="col-sm-2">
				                         		<input type="text" placeholder="Usuario responsable" id="txtusuario" onBlur="upperCase(this)" maxlength="50" class="form-control sm"/>
											</div>
											<label class="control-label col-sm-1" for="txtproyecto">Num. Invent:</label>
											<div class="col-sm-2">
												<input type="text" placeholder="No. de Inventario" id="txtnuminventario" onBlur="upperCase(this)" class="form-control sm" />
											</div>
				                     </div>
				                  </div> 
